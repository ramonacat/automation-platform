  ...
  internal = rec {
    ...
    crates = {
      ...
      "music" = rec {
        ...
        # See https://github.com/NixOS/nix/issues/5410
        src = if ((lib.versionOlder builtins.nixVersion "2.4pre20211007") || (lib.versionOlder "2.5" builtins.nixVersion ))
          then lib.cleanSourceWith { filter = sourceFilter;  src = ../../libraries/rust/music; }
          else ../../libraries/rust/music;
        dependencies = [
          {
            name = "async-std";
            packageId = "async-std";
      ...
      "svc-music" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio-postgres";
            packageId = "tokio-postgres";
            features = [ "with-time-0_3" "with-uuid-1" "with-serde_json-1" ];
          }
          {
            name = "tokio-util";
      ...
      "tokio-util" = rec {
        ...
        resolvedDefaultFeatures = [ "codec" "compat" "default" "full" "futures-io" "futures-util" "hashbrown" "io" "io-util" "net" "rt" "slab" "time" "tracing" ];
      };
      "tracing" = rec {
        crateName = "tracing";
        version = "0.1.37";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "knownfolders" "minwinbase" "minwindef" "objbase" "processenv" "shlobj" "std" "winbase" "wincon" "winerror" "winsock2" "ws2ipdef" "ws2tcpip" ];
      };
