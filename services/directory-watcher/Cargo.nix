...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-walkdir" = rec {
        crateName = "async-walkdir";
        version = "0.2.0";
        edition = "2018";
        sha256 = "145vfq41m9dzzigffn9g99gsd9psc5sl4vjvcd5m1rw77vbqhvc2";
        authors = [
          "Ririsoft <riri@ririsoft.com>"
        ];
        dependencies = [
          {
            name = "async-fs";
      ...
      "kqueue" = rec {
        ...
        version = "1.0.6";
        edition = "2018";
        sha256 = "13hzd65f4mg4bgy7z1f65zvvnn9s3x7x2hksqhx80nbvygl14qad";
        authors = [
      ...
      "postgres-types" = rec {
        ...
        resolvedDefaultFeatures = [ "time-03" "with-time-0_3" ];
      };
      "ppv-lite86" = rec {
      ...
      "tokio-postgres" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "runtime" "with-time-0_3" ];
      };
      "tokio-util" = rec {
